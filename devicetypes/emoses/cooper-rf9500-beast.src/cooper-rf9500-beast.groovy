 ...
 *  IC: 4706C-RF9500
 *
 *  Source availalbe at https://github.com/emoses/ST-Cooper-RF9500-Beast
 *  Forked from https://github.com/ericvitale/ST-CooperRF9500Beast
 *
 */

metadata {
    definition (name: "Cooper RF9500 Beast", namespace: "emoses", author: "evan@emoses.org") {
        capability "Switch"
...
def zwaveEvent(physicalgraph.zwave.Command cmd) {
	log.debug "CRF9500 DH Command ${cmd}"
}